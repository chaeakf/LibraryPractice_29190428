package com.tj.librarypractice_29190428;
...
import com.tj.librarypractice_29190428.databinding.ActivityMainBinding;
            ...
            public void onClick(View v) {
                ...
                PermissionListener permissionListener = new PermissionListener() {
                    ...
                    public void onPermissionGranted() {
                        Uri uri = Uri.parse(String.format("tel:%s", act.phonNumTxt.getText().toString())); // 띄어쓰기 하면 앱이 죽음.: 파싱 실패
                ...
                TedPermission.with(mContext)
                        ...
                        .setDeniedMessage("전화 권환을 거부하면 통화가 불가합니다. [설정]에서 활성화 해주세요.")
